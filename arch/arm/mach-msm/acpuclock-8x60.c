...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[22] = {1620000,  1, 0x1D, 1212500, 1275000, 5},
	[23] = {1728000,  1, 0x1E, 1225000, 1275000, 5},
};

#define L2(x) (&l2_freq_tbl_v2[(x)])
/* SCPLL frequencies = 2 * 27 MHz * L_VAL */
static struct clkctl_acpu_speed acpu_freq_tbl_8x60[] = {
  ...
  { {1, 1},  384000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   812500, 0x03006000},
  ...
  { {1, 1}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(20), 1125000, 0x03006000},
...
static __init struct clkctl_acpu_speed *select_freq_plan(void)
{
	...
	acpu_freq_tbl = acpu_freq_tbl_8x60;
